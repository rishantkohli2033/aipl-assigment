...
const SaveButton = () => (
    <button className="border-gray-300 border-2 hover:bg-neutral-200 text-black  py-1 px-3 rounded-lg mr-2 flex gap-2 items-center"><Save size={20} strokeWidth={1.25} /> Save</button>
  );
